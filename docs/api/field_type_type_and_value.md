...
If you need to inject other services into your Type class, you have to skip using the `parent` config key
...
In order to make the search engine aware of the data stored in a field type, you need to register it as [indexable](field_type_search.md)
